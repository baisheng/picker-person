<template>
    <div class="cd-cart-container ">
        <a href="#0" class="cd-cart-trigger fab-menu-bottom-right">
            Cart
        ...
        <ul class="fab-menu fab-menu-fixed fab-menu-bottom-right" @click="toggle">
            <li>
                <a class="fab-menu-btn btn bg-teal-400 btn-float btn-rounded btn-icon legitRipple ">
