...
export default class extends Base {
    ...
    async getAction(self){
        ...
        if (this.id){
            ...
            // _resume['content_json'] = JSON.stringify(_resume['content_json']);
            // if (typeof(_resume['meta']._resume_section) !== "undefined") {
        ...
        if (this.isGet()) {
            ...
            if (!think.isEmpty(_id)) {
                ...
                if (!think.isEmpty(_resume)) {
                    // this.assign("_resume", _resume);
                    return this.json(_resume);
                    // console.log(JSON.stringify(_resume))
                    // this.assign("_id", _id);
                    // this.assign("_title", _resume.title);
                    // this.assign("_type", _resume.type);
                    // _resume.content_json = JSON.parse(_resume.content_json)
                    // console.log(JSON.stringify(_resume.content_json))
