...
export default class extends think.service.base {
    ...
    async insertData() {
        ...
        let dbFile = think.ROOT_PATH + think.sep + 'picker.sql';
        ...
        content = content.replace(/\/\*.*?\*\//g, '').replace(/picker_/g, this.dbConfig.prefix || '');
        ...
        await optionsModel.where({key: 'navigation'}).update({
            value: JSON.stringify([{
                ...
                "url": "/tags",
                "option": "tags"
            }, {"label": "关于", "url": "/about", "option": "user"}, {"label": "友链", "url": "/links", "option": "link"}])
        });
