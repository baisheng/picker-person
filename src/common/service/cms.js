...
export default class extends think.service.base {
  ...
  async createPageDirectory(page){
  ...
  async findMatchingTemplate(page, options){
      new Promise((resolve, reject) => {
  ...
  async compileTemplate(template, page, options){
    ...
    async writeOutputFile(compiled, page){
        new Promise((resolve, reject) => {
