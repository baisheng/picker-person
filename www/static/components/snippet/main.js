...
var _defineProperty2 = __webpack_require__(417);
...
new Vue({
    ...
    }, (0, _defineProperty3.default)(_methods, 'renderSelect2', function renderSelect2() {
        function iconFormat(icon) {
            var originalOption = icon.element;
            if (!icon.id) {
                return icon.text;
    ...
    }), (0, _defineProperty3.default)(_methods, 'urlParam', function urlParam(name) {
    ...
    }), (0, _defineProperty3.default)(_methods, '_fetch', function _fetch() {
        this.checked = [];
        var vue = this;
        var _url = "/admin/posts/list?type" + this.type;
        // if (!type) {
        //     _url += 'list'
        // }
        // else {
    ...
    watch: { //深度 watcher
        ...
        snippet_code_lang: function snippet_code_lang(val, oldVal) {
