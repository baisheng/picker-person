...
new Vue({
    ...
    components: {
        JsonEditor: _jsonEditor2.default
    },
    ...
    methods: {
        /*
         ...
         user  :列表中某一行数据
         */
        editable: function editable(e, field, user) {
...
Component.options.__file = "/Users/bison/__task/19_Caixie/__workspace/picker-resume/webpack/components/ui/json-editor.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] json-editor.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8223df60", Component.options)
  } else {
    hotAPI.reload("data-v-8223df60", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8223df60", module.exports)
  }
}
